...
![代码主流程理解](docs/assets/demo_main_flow.png)

### 项目复现步骤生成

![项目复现步骤生成](docs/assets/demo_reproduce.png)

### 运行命令生成

![运行命令生成](docs/assets/demo_command.png)

为便于展示，以上截图仅保留部分关键输出。实际运行时，Agent 会根据源码检索结果生成更完整的分析内容。
